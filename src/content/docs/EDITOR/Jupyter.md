...
之后可以用浏览器的打印功能，将 `html` 文件转为 _PDF_。如果偏爱脚本也可以用 [无头浏览器](../NET/Chrome.md#无头模式) 来打印
...
> [!tip] Quarto
> 若目的仅是生成文档，完全不需要即时探索，则可以了解一下 [Quarto](../DOC/Quarto.md)。这是一个开源的科技出版系统，用和 `md` 一样简洁的 `qmd` 作为源文件，只在构建时运行代码，并可导出为多种文档格式。
