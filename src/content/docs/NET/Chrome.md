...
在 [Web 开发](../APP/Web.md#浏览器) 章节有简略的介绍，更多内容详见 [官方文档](https://developer.chrome.com/docs/devtools)。
...
>
> Windows 系统自带了 Microsoft Edge，但它并不在 `PATH` 中。可以 [使用 Scoop 添加 shim](../PM/Scoop.md#管理脚本和命令) 来方便地使用 Microsoft Edge 的无头模式
>
> ```sh
