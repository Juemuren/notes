...
- [编辑器](../EDITOR/index.md#分类)
- [包管理器](../PM/index.md#分类)
- [环境管理器](../EM/index.md#分类)
- [网络工具](../NET/index.md#工具)
- [安全工具](../SEC/index.md#工具)
- [文档工具](../DOC/index.md#工具)
- [数据处理工具](../DATA/index.md#工具)

> [!note] 语言相关的工具
> 与特定编程语言有关的 CLI 工具，比如编译器、解释器、调试器、语言包管理器、构建工具、格式化工具、静态检查工具、动态分析工具等就不列举在这里了，可以去 [编程语言](../PL/index.md) 章节查阅有关特定语言的部分
