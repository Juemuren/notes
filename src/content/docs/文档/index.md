...
- [Chrome](../网络/Chrome.md) 虽然是浏览器，但提供了 Headless 模式，可以用脚本批量将 HTML 打印为 PDF
...
- [Jupyter](Jupyter.mdx) 交互式编程笔记本，功能非常强大。适合学习和探索，但不太适合大型工程项目
- Marimo 响应式 Python 笔记本，采用更现代的设计，git 友好且能够根据依赖关系自动重新运行代码

更适合生成文档的

- [Quarto](Quarto.md) 基于 Pandoc 的开源科技出版系统
